  ...
  <div class="user"> 
    <div class="dropdown">	
        ...
        <div id="myDropdown" class="dropdown-content">
            <a href="/1000womenapp/admin/profile" class="fas fa-user">  Profile</a>
            <a href="/1000womenapp/admin/contact.php" class="fas fa-envelope-open-text">  Contact us</a>
            <a href="/1000womenapp/admin/logout.php" class="fas fa-power-off logout">  Logout</a> 
        </div>
    </div>
  </div>
</div>
...
<div class="forum-content" ><?php echo $post_content ?></div>
   ...
   <?php
      ...
      if(isset($_SESSION['user_role'])){
         ...
         if(isset($_GET['p_id'])){
            ...
            $the_post_id = mysqli_real_escape_string($connection, trim($_GET['p_id']));
            echo "<div class='container-for-post-section-edit-btn'><a href='/1000womenapp/admin/posts.php?source=edit_post&p_id={$the_post_id}'><button class='forum-section-edit-btn'>Edit Post</button></a></div>";
         }
      } 
   }else{
