...
<div class="forum-section" id="main">
  ...
  $select_all_post_query = mysqli_query($connection, $query);
     ...
     <hr class="line-rule">
     <a href="/1000womenapp/admin/post/<?php echo $post_id; ?>"><img class="forum-image" src="/1000womenapp/images/<?php echo $post_image ?>" alt="image"></a>
     
     
     <pre class="forum-content">Inspiration: 
