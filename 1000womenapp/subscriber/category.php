...
<head>
    ...
    <link rel="stylesheet" href="/1000womenapp/dist/css/category.css">
...
<div class="forum-section" id="main">
  ...
  if(isset($_GET['category'])){
     $post_category_id = mysqli_real_escape_string($connection, trim($_GET['category']));
  }
  ...
  $select_all_post_query = mysqli_query($connection, $query);
     ...
     <h2 class="forum-title"><a href="/1000womenapp/subscriber/post/<?php echo $post_id; ?>" class="forum-title-link" ><?php echo $post_title ?></a></h2>
     ...
     <hr class="line-rule">
     <a href="/1000womenapp/subscriber/post/<?php echo $post_id; ?>"><img class="forum-image" src="/1000womenapp/images/s<?php echo $post_image ?>" alt="image"></a>
     
     
     <pre class="forum-content">Inspiration: "<?php echo $post_quote ?>" 
                -<?php echo $post_author?>
          
          </pre> 


     <a href="/1000womenapp/subscriber/post/<?php echo $post_id;?>" class="forum-title-link" ><button class="read-more-btn">Read More</button></a>
        </div>
        <hr class="line-rule"> 
     <?php } 
  ...
  <div class="forum-side">
    <div class="forum-side-container">
          ...
          <ul>
              <?php 
                  while($row = mysqli_fetch_assoc($select_categories_sidebar)) {
                      ...
                      $cat_id =  $row['cat_id'];
                      echo "<li class='forum-categories'><a href='/1000womenapp/subscriber/category/{$cat_id} '>{$cat_title}</a></li>";
                  }
              ?>  
          </ul>
      </div>
