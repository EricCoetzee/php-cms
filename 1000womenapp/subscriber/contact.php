...
<h2>Contact us</h2>
<p>Have a story to tell? Please contact us to get your story published in his application</p>
...
<div class="container">
  <form action="contact.php" method="POST">
    ...
    <div class="row">
      <div class="col-25">
        <label for="sject">Subject</label>
      </div>
      <div class="col-75">
        <input type="text" id="sject" name="subject" placeholder="Your Subject..">
      </div>
    </div>
